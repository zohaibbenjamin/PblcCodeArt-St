//
//  CreateCustomPackageViewController.swift
//  ArtStation
//
//  Created by Andpercent on 12/01/2022.
//

import UIKit

class CreateCustomPackageViewController: UIViewController {
    ...
    func onSubmit() {
        ...
        params["artist_id"] = self.artistID
        params["description"] = self.customPakcagetext.text
        params["userType"] = (self.artistData?.role_id == 3) ? "Entertainer" : "Artist"
